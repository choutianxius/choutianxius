...
\mySecondaryItem{
  Improve sentiment and engagement for over 100 million predicted parents on Instagram through in-app marketing promotions. Navigate campaigns through tight timelines with robust engineering scoping and effective cross-functional alignment.
}
\mySecondaryItem{
  Strengthen the reliability of Instagram's parent-facing marketing system with comprehensive logging, alerting, and AI-assisted early anomaly detection and metrics reporting.
}
\itemListEnd
